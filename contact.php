...
<html class="no-js">
    <head>
        <meta charset="utf-8">
        <title>Kontak Kami | Investani</title>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-xs-12 text-right">
                        ...
                        <ul class="list-unstyled list-inline header-social">
							...
							<li><a class="is-active" href="#" data-toggle="modal" data-target="#registerModal" >Daftar</a></li>    
                       </ul> <!-- /.header-social  -->
                ...
                <div id="navbar" class="navbar-collapse collapse pull-right">
                  ...
                  <ul class="nav navbar-nav">
                    ...
                    <li><a href="about.php">Tentang Kami</a></li>
                     ...
                     <li><a class="is-active" href="contact.php">Kontak Kami</a></li>
	...
	<div class="page-heading text-center">
		...
		<div class="container zoomIn animated">
			...
			<h1 class="page-title">Kontak Kami <span class="title-under"></span></h1>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-7 col-sm-12 col-form">
					...
					<h2 class="title-style-2">FORM KONTAK <span class="title-under"></span></h2>
				...
				<div class="col-md-4 col-md-offset-1 col-contact">
					...
					<h2 class="title-style-2">INVESTANI<span class="title-under"></span></h2>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="donateModalLabel"><center>MASUK</center></h4>
          </div>
    ...
    <div class="modal fade" id="registerModal" tabindex="-1" role="dialog" aria-labelledby="registerModal" aria-hidden="true">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title" id="donateModalLabel"><center>DAFTAR</center></h4>
          </div>
		  <div class="modal-body">
		  <div class="row">
                          <center><div class="form-group col-md-6">
