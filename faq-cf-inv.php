...
<html class="no-js">
              ...
              <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse pull-right">
                  ...
                  <ul class="nav navbar-nav">
					...
					<li><a  class="is-active" href="faq-cf-inv.php">FAQ</a></li>
    ...
    <div class="panel-group" id="accordion">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFour">Bagaimana cara saya menjadi investor? </a>
                </h4>
            </div>
            <div id="collapseFour" class="panel-collapse collapse">
                <div class="panel-body">
                    Setelah mendaftar menjadi investor , silahkan buka halaman <a href="proyek.php">Proyek </a> , anda akan melihat berbagai proyek dengan pengumpulan dana yang masi terbuka.
					Anda dapat melakukan investasi dengan membeli minimal 1 lembar saham dengan harga yang telah ditentukan.
                </div>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFive">Bagaimana saya dapat memantau proyek yang saya danai?</a>
                </h4>
            </div>
            <div id="collapseFive" class="panel-collapse collapse">
                <div class="panel-body">
                    Akan disediakan halaman dashboard yang berisi semua informasi progress yang anda butuhkan. Jika terdapat pertanyaan lebih lanjut terkait progress proyek anda dapat menghubungi
					inisiator atau pengelola proyek tersebut.
                </div>
            </div>
        </div>
        <div class="panel panel-default">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseSeven">Jika proyek telah selesai , bagaimana saya dapatkan hasil saya?</a>
                </h4>
            </div>
            <div id="collapseSeven" class="panel-collapse collapse">
                <div class="panel-body">
                    Setelah proyek selesai dikerjakan dan hasil diterima , keuntungan  anda akan langsung dikirimkan ke virtual bank account anda. Anda dapat mencairkannya atau melakukan investasi 
					lagi pada proyek proyek lainnya.
                </div>
            </div>
        </div>
        <div class="panel panel-default">
