    ...
    <body>
        ...
        <div class="page-heading text-center">
            <div class="container zoomIn animated">
                <h1 class="page-title">Masuk <span class="title-under"></span></h1>
                    ...
                    <div align="center">
                        <form class="form-login" method="post" action="cek_login.php">
                            ...
                            <div class="form-group col-md-6 col-md-offset-6">
									<input type="submit" class="btn btn-primary pull-right" name="login">                       
                                     </div>
                        </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="donateModalLabel">DAFTAR</h4>
          </div>
