                        ...
                        <div class="col-sm-6 col-xs-12 text-right">
                            <ul class="list-unstyled list-inline header-social">
                                <li><img src="assets/images/icons/wallet.png"></li>
                                    <li><a class="is-active" href="saldo-cf-in.php">Rp 2.000.000</a></li>
                ...
                <div class="container">
                    ...
                    <div id="navbar" class="navbar-collapse collapse pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a class="is-active" href="profil-cf-in.php">Profil</a></li>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 personal-info">
                        <form class="form-horizontal" role="form" action="cek_edit_in.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <span></span>
                                    <a class="btn btn-default" href="profil-cf-in.php">Batal</a>
                                </div>
                            </div>
                        </form>
                    </div>
