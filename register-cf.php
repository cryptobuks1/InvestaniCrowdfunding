...
<html class="no-js">
    <head>
        <meta charset="utf-8">
        <title>Daftar | Crowdfunding Investani</title>
    ...
    <body>
                ...
                <div class="navbar-top">
                    <div class="container">
                        <div class="row">
							...
							<li><a class="is-active" href="#" data-toggle="modal" data-target="#loginModal" >Masuk</a></li>    
								</ul> <!-- /.header-social  -->
        ...
        <div class="page-heading text-center">
            <div class="container zoomIn animated">
                <h1 class="page-title">Daftar <span class="title-under"></span></h1>
        ...
        <div class="main-container">
         	<div class="container zoomIn animated">
                    <div align="center">
                        <form class="form-register" method="post" action="cek_daftar.php">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <select id="kategori_daftar" class="form-control" name="kategori">
                                        <option value="user1">Investor</option>
                                        <option value="user2">Inisiator</option>
                                        <option value="user3">Pengelola</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <input type="submit" class="btn btn-primary pull-right" name="register">
                                </div>
                            </div>
                        </form>
                    </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="donateModalLabel">MASUK</h4>
          </div>
		  <div class="modal-body">
		  <div class="row">
                            <div class="form-group col-md-6">
							<a href="login-cf.php"><img src="assets/images/ptpnx-logo.png"><div>CrowdFunding</div></a>
                            </div>
                            <div class="form-group col-md-6">
							<a href="login-p2p.php"><img src="assets/images/ptpnx-logo.png"><div>Peer to Peer</div></a>
                            </div>
                        </div>
          </div>
        </div>
